...
document.localization ['en_US'] = {
    ...
    'button.add': 'Add',
    'button.add.play.store': 'Add from Play Store',
    ...
    'error.configuration.location.latitude': 'Please enter a latitude from -90 to 90',
    'error.configuration.location.longitude': 'Please enter a longitude from -180 to 180',
    'error.configuration.location.radius': 'Please enter a location range greater than 0 meters',
    'error.device.location.latitude': 'Please enter a device latitude from -90 to 90',
    'error.device.location.longitude': 'Please enter a device longitude from -180 to 180',
    'error.device.location.radius': 'Please enter a device location range greater than 0 meters',
    ...
    'error.invalid.play.store.input': 'Enter a valid Play Store link or package ID',
    ...
    'form.configuration.apps.action.select': 'Choose action',
    'form.configuration.apps.action.install': 'Allow',
    'form.configuration.apps.action.prohibit': 'Block',
    'form.configuration.apps.action.not.install': 'Block',
    ...
    'form.configuration.apps.hint': 'Allow lets the app run in kiosk. Block hides/prevents the app in this configuration. Delete removes it from the tablet when the device syncs.',
    ...
    'form.configuration.settings.location.enabled': 'Enable location range',
    'form.configuration.settings.location.latitude': 'Latitude',
    'form.configuration.settings.location.latitude.placeholder': 'Allowed latitude',
    'form.configuration.settings.location.longitude': 'Longitude',
    'form.configuration.settings.location.longitude.placeholder': 'Allowed longitude',
    'form.configuration.settings.location.radius': 'Range, meters',
    'form.configuration.settings.location.radius.placeholder': 'Allowed range in meters',
    'form.configuration.settings.location.hint': 'When enabled, the tablet is locked if its current location is outside the configured range. The last synced values continue working offline.',
    ...
    'form.application.install.source': 'Install method',
    'form.application.install.source.apk': 'Upload APK',
    'form.application.install.source.apk.hint': 'Best for kiosk devices. Upload an APK file and Headwind installs it from your server.',
    'form.application.install.source.play': 'Play Store link',
    'form.application.install.source.play.hint': 'Creates a Play Store app entry. This opens Google Play on the tablet; silent install requires Android Enterprise.',
    'form.application.install.source.preinstalled': 'Already on tablet',
    'form.application.install.source.preinstalled.hint': 'Use this when the app is already installed or built into the tablet. Enter its package ID.',
    'form.application.url.hint': 'Use market://details?id=com.example.app for Play Store apps, or file:///storage/emulated/0/... for local files and folders',
    'form.application.play.store': 'Play Store install',
    'form.application.play.store.title': 'Create an app entry which opens Google Play on the tablet for this package',
    'form.application.play.store.hint': 'Paste a Play Store link or package ID; APK upload is not needed.',
    'form.application.play.store.input': 'Play Store app',
    'form.application.play.store.input.placeholder': 'Paste Play Store link or package ID',
    'form.application.play.store.input.hint': 'Example: https://play.google.com/store/apps/details?id=com.whatsapp or com.whatsapp',
    ...
    'form.device.location.settings': 'Individual location range',
    'form.device.location.latitude': 'Latitude',
    'form.device.location.latitude.placeholder': 'Tablet latitude',
    'form.device.location.longitude': 'Longitude',
    'form.device.location.longitude.placeholder': 'Tablet longitude',
    'form.device.location.radius': 'Range, meters',
    'form.device.location.radius.placeholder': 'Allowed range in meters',
    ...
    'tab.configeditor.location.settings': 'Location Settings',
